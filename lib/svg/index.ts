...
import AlignJustify from "./align-justify.svg?react";
...
import CalendarExclamation from "./calendar-exclamation.svg?react";
import CalendarLines from "./calendar-lines.svg?react";
...
import ChartScatterBubble from "./chart-scatter-bubble.svg?react";
...
import FileDownloadPdf from "./file-download-pdf.svg?react";
import FileDownloadXml from "./file-download-xml.svg?react";
...
import LocationPinLock from "./location-pin-lock.svg?react";
...
export default {
  ...
  'chart-pie': ChartPie,
  'chart-scatter-bubble': ChartScatterBubble,
  ...
  'file-download-pdf': FileDownloadPdf,
  'file-download-xml': FileDownloadXml,
  ...
  'location-pin-lock': LocationPinLock,
